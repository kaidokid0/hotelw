...
<div class="container-fluid  px-4">
        ...
        <ol class="breadcrumb mb-4">
            ...
            <li class="breadcrumb-item active">Users Information DataTable</li>
        </ol>
                    ...
                    <div class="card-body">
                        ...
                        <table id="datatablesSimple">
                            ...
                            <tbody>
								...
								$query = "SELECT * FROM users WHERE role_as LIKE 'User'";
                            ...
                            <tr>
								...
								<td>
									...
									<button name="userdelete_btn" value="<?= $row['id']; ?>" type="submit" class="btn btn-danger">Delete</button>
									</form>
								</td>
