...
<div class="container-sm px-4">
	<h4 class="mt-4">Edit Admin Information</h4>
	 <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">Edit Admin Information</li>
    </ol>
    <div class="row">
    	<div class="col-md-12">
    		<div class="card">
    					...
    					<div class="row">
                            ...
                            <div class="d-grid gap-2 d-md-block">
                                <td><a href="admininfo.php" class="btn btn-danger">Back</a></td>
                                 <button type="submit" name="updateadmin_btn" class="btn btn-primary">Save</button>
                            </div>
