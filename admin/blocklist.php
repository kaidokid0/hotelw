...
<div class="container-fluid  px-4">
        <h1 class="mt-4">Block List Tables</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
            <li class="breadcrumb-item active">Block List Information DataTable</li>
        </ol>
                    ...
                    <div class="card-body">
                        ...
                        <table id="datatablesSimple">
                            ...
                            <tbody>
								...
								$query = "SELECT * FROM users WHERE role_as LIKE 'Block'";
                            ...
                            <tr>
								...
								<td>
									<a href="blocklist_unblock.php?id=<?= $row['id'];?>" class="btn btn-success">Unblock</a>
								</td>
