...
<div class="container-fluid  px-4">
        <h1 class="mt-4">Missed Table</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
            <li class="breadcrumb-item active">Missed DataTable</li>
        </ol>
                        ...
                        <table id="datatablesSimple">
                            <thead>
                                <tr>
									...
									<th>Missed By ID Account Number:</th>
									<th>Date & Time Missed</th>
									<th>Unmissed</th>
                                </tr>
                            </thead>
                            <tfoot>
                            ...
                            <tbody>
								...
								$query = "SELECT * FROM booking WHERE status LIKE 'Missed'";
                            ...
                            <tr>
								...
								<td><?= $row['missed_by']; ?></td>
								<td><?= $row['markmissed_at']; ?></td>

								<!-- Block -->
                                <!-- miss -->
                                <td>
                                    <a href="unmissedbooking.php?id=<?= $row['id'];?>" class="btn btn-danger text-white">Unmissed</a>
                                </td>
