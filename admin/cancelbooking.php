                ...
                <div class="card-body">
                    ...
                    <form action="bookingcode.php" method="POST">
                        <div class="row">
                            ...
                            <!--  status  -->
                             <input required readonly="readonly" type="hidden" name="status" value="Cancel">
                            ...
                            <div class="d-grid gap-2 d-md-block">
                                ...
                                <button type="submit" name="cancelbooking_btn" class="btn btn-secondary">Cancel</button>
                            </div>
