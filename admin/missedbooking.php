...
<div class="container-sm px-4">
	<h4 class="mt-4">Booking Pending Table</h4>
	 <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">Missed Pending Booking</li>
    </ol>
    <div class="row">
    	<div class="col-md-12">
    		<div class="card">
    			<div class="card-header">
    				<h4>Missed Pending Booking</h4>
    			</div>
    			<div class="card-body">
    				...
    				<form action="bookingcode.php" method="POST">
    					<div class="row">
                            ...
                            <!--  status  -->
                             <input required readonly="readonly" type="hidden" name="status" value="Missed">

							<!--  Missed by ID account -->
							<div class="col-md-6 mb-3">
								<input name="missed_by" required type="hidden" value="<?= $_SESSION['auth_user']['user_id'] ?>">
							</div>

                            <!-- missed_at -->
                            <div class="col-md-6 mb-3">
                                <input name="markmissed_at" type="hidden" value="<?php echo date("Y-m-d h:i:sa", $today); ?>">
                            </div>

							<!--  Button to insert to database/ create account -->
                            <div class="d-grid gap-2 d-md-block">
                                <td><a href="bookingpending.php" class="btn btn-danger">Back</a></td>
                                <button type="submit" name="missedbooking_btn" class="btn btn-primary">Missed</button>
                            </div>
