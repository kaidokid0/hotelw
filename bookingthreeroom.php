			...
			<div class="col-md-5">
				...
				<div class="card">
					<div class="card-header">
						<h4>Booking Form in Triple Bed</h4>
					</div>

					<div class="card-body">

						<form  action="bookingcode2.php" method="POST">
							...
							<!-- Price -->
							<div class="form-group mb-3">
								<input required type="hidden" name="price" value="4000">
							</div>
							...
							<div class="d-grid gap-2 d-md-block">
                                ...
                                <button type="submit" name="threeroom_btn" class="btn btn-primary">Book</button>
                            </div>
