			...
			<div class="col-md-5">
				...
				<div class="card">
					<div class="card-header">
						<h4>Booking Form in Double Bed</h4>
					</div>

					<div class="card-body">

						<form  action="bookingcode1.php" method="POST">
							...
							<!-- Price -->
							<div class="form-group mb-3">
								<input required type="hidden" name="price" value="3000">
							</div>

							<!--  Button to insert to database/ create account -->
							<div class="d-grid gap-2 d-md-block">
                                <td><a href="offer.php" class="btn btn-danger">Back</a></td>
                                <button type="submit" name="tworoom_btn" class="btn btn-primary">Book</button>
                            </div>
